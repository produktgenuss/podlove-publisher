...
class Podlove_Web_Player_Admin {
  ...
  private $options;
    ...
    if (filter_input(INPUT_GET, 'page') != 'podlove-web-player-settings') {
      return;
    }
    wp_enqueue_script( $this->plugin_name . '-player', 'https://cdn.podlove.org/web-player/embed.js', array(), $this->version, true );
    wp_enqueue_script($this->plugin_name . '-configurator', \Podlove\PLUGIN_URL . '/js/dist/player-configurator.js', array(), $this->version, true);
